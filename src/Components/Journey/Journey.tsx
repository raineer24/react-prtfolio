...
// Journey Timeline Component - Shows career progression
// Add this between About and Projects sections
...
const Journey: React.FC = () => {
  const milestones = [
    ...
    },
    {
      ...
      description: 'Contributing to enterprise internship platform with Next.js 14 and TypeScript. Implementing real-time features, authentication flows, and complex workflows for production use.',
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <p style={{
            ...
            From e-commerce systems to production apps generating real revenue
          </p>
        </div>
